...
class Gstr2B2BReportScreen extends StatefulWidget {
  final List<PurchaseInvoiceData> invoices;
  final List<Customer> suppliers;

  const Gstr2B2BReportScreen({
    super.key,
  ...
  @override
  State<Gstr2B2BReportScreen> createState() => _Gstr2B2BReportScreenState();
}

class _Gstr2B2BReportScreenState extends State<Gstr2B2BReportScreen> {
  List<_B2BRow> rows = [];
  ...
  @override
  void didUpdateWidget(covariant Gstr2B2BReportScreen oldWidget) {
  ...
  Widget build(BuildContext context) {
    return rows.isEmpty
        ? const Center(child: Text("No B2B Purchase Data"))
        : Column(
            children: [
              Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      ...
                      TableStyle.globalSum("No. of Invoices:", "$noOfInvoices"),
                      TableStyle.globalSum(
                        "Total Invoice Value:",
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                    ...
                    columns: [
                      ...
                      TableStyle.label("IGST Paid"),
                      TableStyle.label("CGST Paid"),
                      TableStyle.label("SGST Paid"),
