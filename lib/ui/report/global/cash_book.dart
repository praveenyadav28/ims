...
class _CashBookReportScreenState extends State<CashBookReportScreen> {
  ...
  Future<void> exportCashBookExcel() async {
    ...
    final file = File(
      "${dir.path}/CashBook_${selectedLedger!.ledgerName}_${DateFormat('ddMMyyyy_HHmm').format(DateTime.now())}.xlsx",
    );
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text("Cash Book Excel exported successfully")),
    );
  }
